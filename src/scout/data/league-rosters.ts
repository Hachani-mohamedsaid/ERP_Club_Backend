...
export const LEAGUE_ROSTERS: Record<string, CountryRoster> = {
  gb: {
    ...
    teams: [
      ...
      { name: 'Leeds United', city: 'Leeds', avgPotential: 76, logoColor: 'FFFFFF' },
      { name: 'Burnley', city: 'Burnley', avgPotential: 74, logoColor: '6C1D45' },
      { name: 'Sunderland', city: 'Sunderland', avgPotential: 75, logoColor: 'EB172B' },
